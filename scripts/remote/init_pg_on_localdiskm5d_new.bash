...
then
  ...
  sudo cp -R /var/lib/postgresql/10/main /mnt/main
  sudo chown -R postgres /mnt/main
  sudo chgrp -R postgres /mnt/main
  sudo mv /var/lib/postgresql/10/main /var/lib/postgresql/10/main_aside
  sudo -u postgres ln -s /mnt/main /var/lib/postgresql/10/main 
  sleep 1
